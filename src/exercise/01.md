...
If the element already exists (like root), use getDocumentById, otherwise add a tag with createElement (ex. div), set the attributes explicitly (ex. element.textContent = 'Hello world') or with the method setAttribute, then append them to the father element with append.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=alessandrosommarug%40gmail.com).
