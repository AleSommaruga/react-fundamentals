...
Use React and ReactDOM to createElement and render elements respectively, instead of doing it in the standard way (createElement and set attributes). If there are nested elements, just define them before, pass them to the father as additional parameters in createElement and render them just once at the end.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=alessandrosommarug%40gmail.com).
